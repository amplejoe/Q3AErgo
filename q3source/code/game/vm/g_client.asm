...
export setRewardPercentages
proc setRewardPercentages 44 0
line 987
;982:}
;983:
;984:// [ERGO MOD START]
;985:// sets and redistributes award percentages (e.g. if award options are turned off)
;986:void setRewardPercentages(gentity_t *ent)
;987:{
line 990
;988:	gclient_t	*client;
;989:
;990:	client = ent->client;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
line 993
;991:
;992:	// set original values
;993:	client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] = (float) REWARD_DROPRATE_ITEMS;
ADDRLP4 0
INDIRP4
CNSTI4 668
ADDP4
...
ASGNF4
line 994
;994:	client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] = (float) REWARD_DROPRATE_WEAPONS;
ADDRLP4 0
INDIRP4
CNSTI4 672
ADDP4
...
ASGNF4
line 995
;995:	client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] = (float) REWARD_DROPRATE_POWERUPS;
ADDRLP4 0
INDIRP4
CNSTI4 676
ADDP4
...
line 998
;996:	
;997:	// redistribute depending on ergoflags
;998:	if (!(client->sess.ergoFlags & E_FL_ITEMS) && !(client->sess.ergoFlags & E_FL_WEAPONS))
ADDRLP4 4
ADDRLP4 0
INDIRP4
CNSTI4 732
...
;999:	{
line 1000
;1000:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 668
ADDP4
...
ASGNF4
line 1001
;1001:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 672
ADDP4
...
ASGNF4
line 1002
;1002:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] = 1.0;
ADDRLP4 0
INDIRP4
CNSTI4 676
ADDP4
...
LABELV $343
line 1004
;1004:	else if (!(client->sess.ergoFlags & E_FL_ITEMS) && !(client->sess.ergoFlags & E_FL_POWERUPS))
ADDRLP4 12
ADDRLP4 0
INDIRP4
CNSTI4 732
...
;1005:	{
line 1006
;1006:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 668
ADDP4
...
ASGNF4
line 1007
;1007:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] = 1.0;
ADDRLP4 0
INDIRP4
CNSTI4 672
ADDP4
...
ASGNF4
line 1008
;1008:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 676
ADDP4
...
LABELV $345
line 1010
;1010:	else if (!(client->sess.ergoFlags & E_FL_WEAPONS) && !(client->sess.ergoFlags & E_FL_POWERUPS))
ADDRLP4 20
ADDRLP4 0
INDIRP4
CNSTI4 732
...
;1011:	{
line 1012
;1012:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] = 1.0;
ADDRLP4 0
INDIRP4
CNSTI4 668
ADDP4
...
ASGNF4
line 1013
;1013:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 672
ADDP4
...
ASGNF4
line 1014
;1014:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 676
ADDP4
...
LABELV $347
line 1016
;1016:	else if (!(client->sess.ergoFlags & E_FL_ITEMS))
ADDRLP4 0
INDIRP4
CNSTI4 732
ADDP4
...
;1017:	{
line 1018
;1018:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] / 2.0;
ADDRLP4 32
ADDRLP4 0
INDIRP4
CNSTI4 672
...
ASGNF4
line 1019
;1019:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] / 2.0;
ADDRLP4 40
ADDRLP4 0
INDIRP4
CNSTI4 676
...
ASGNF4
line 1020
;1020:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 668
ADDP4
...
LABELV $349
line 1022
;1022:	else if (!(client->sess.ergoFlags & E_FL_WEAPONS))
ADDRLP4 0
INDIRP4
CNSTI4 732
ADDP4
...
;1023:	{
line 1024
;1024:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] / 2.0;
ADDRLP4 32
ADDRLP4 0
INDIRP4
CNSTI4 668
...
ASGNF4
line 1025
;1025:			client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] / 2.0;
ADDRLP4 40
ADDRLP4 0
INDIRP4
CNSTI4 676
...
ASGNF4
line 1026
;1026:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 672
ADDP4
...
LABELV $351
line 1028
;1028:	else if (!(client->sess.ergoFlags & E_FL_POWERUPS))
ADDRLP4 0
INDIRP4
CNSTI4 732
ADDP4
...
;1029:	{
line 1030
;1030:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] / 2.0;
ADDRLP4 32
ADDRLP4 0
INDIRP4
CNSTI4 668
...
ASGNF4
line 1031
;1031:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS] += client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] / 2.0;
ADDRLP4 40
ADDRLP4 0
INDIRP4
CNSTI4 672
...
ASGNF4
line 1032
;1032:		client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS] = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 676
ADDP4
...
;1034:}
LABELV $342
endproc setRewardPercentages 44 0
export ClientBegin
...
;1039:ClientBegin
;1040:
;1041:called when a client has finished connecting, and is ready
;1042:to be placed into the level.  This will happen every level load,
;1043:and on transition between teams, but doesn't happen on respawns
;1044:============
;1045:*/
;1046:void ClientBegin( int clientNum ) {
line 1052
;1047:	gentity_t	*ent;
;1048:	gclient_t	*client;
;1049:	gentity_t	*tent;
;1050:	int			flags;
;1051:
;1052:	ent = g_entities + clientNum;
ADDRLP4 4
CNSTI4 808
ADDRFP4 0
INDIRI4
...
line 1054
;1053:
;1054:	client = level.clients + clientNum;
ADDRLP4 0
CNSTI4 916
ADDRFP4 0
INDIRI4
...
line 1064
;1063:
;1064:	client->pers.connected = CON_CONNECTED;
ADDRLP4 0
INDIRP4
CNSTI4 468
ADDP4
...
ASGNI4
line 1065
;1065:	client->pers.enterTime = level.time;
ADDRLP4 0
INDIRP4
CNSTI4 552
ADDP4
...
ASGNI4
line 1066
;1066:	client->pers.teamState.state = TEAM_BEGIN;
ADDRLP4 0
INDIRP4
CNSTI4 556
ADDP4
...
;1067:
;1068:	// [ERGO MOD START]
;1069:	// no cycle or beat yet received
;1070:	client->pers.lastBikeCycleTime = -1;
ADDRLP4 0
INDIRP4
CNSTI4 616
ADDP4
...
ASGNI4
line 1071
;1071:	client->pers.lastHeartBeatTime = -1;
ADDRLP4 0
INDIRP4
CNSTI4 632
ADDP4
...
ASGNI4
line 1072
;1072:	client->pers.brSampleCount = 0;
ADDRLP4 0
INDIRP4
CNSTI4 620
ADDP4
...
ASGNI4
line 1073
;1073:	client->pers.hrSampleCount = 0;
ADDRLP4 0
INDIRP4
CNSTI4 636
ADDP4
...
ASGNI4
line 1074
;1074:	client->pers.brSampleSum = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 624
ADDP4
...
ASGNF4
line 1075
;1075:	client->pers.hrSampleSum = 0.0;
ADDRLP4 0
INDIRP4
CNSTI4 640
ADDP4
...
ASGNF4
line 1076
;1076:	client->pers.hrNumSamples = HR_DEFAULT_NUM_SAMPLES; // adjustable with key (keypad up / down)
ADDRLP4 0
INDIRP4
CNSTI4 644
ADDP4
...
ASGNI4
line 1077
;1077:	client->pers.currentCycleRate = 0;
ADDRLP4 0
INDIRP4
CNSTI4 628
ADDP4
...
ASGNF4
line 1078
;1078:	client->pers.currentHeartRate = 0;
ADDRLP4 0
INDIRP4
CNSTI4 648
ADDP4
...
ASGNF4
line 1080
;1079:	// set heart rate zones
;1080:	client->pers.minRecoveryHR = HR_RECOVERY_LOWER_BOUND * (float) client->sess.maxHeartRate;
ADDRLP4 0
INDIRP4
CNSTI4 652
ADDP4
...
ASGNF4
line 1081
;1081:	client->pers.minAerobicHR = HR_AEROBIC_LOWER_BOUND * (float) client->sess.maxHeartRate;
ADDRLP4 0
INDIRP4
CNSTI4 656
ADDP4
...
ASGNF4
line 1082
;1082:	client->pers.minAnaerobicHR = HR_ANAEROBIC_LOWER_BOUND * (float) client->sess.maxHeartRate;
ADDRLP4 0
INDIRP4
CNSTI4 660
ADDP4
...
ASGNF4
line 1083
;1083:	client->pers.maxAnaerobicHR = HR_ANAEROBIC_UPPER_BOUND * (float) client->sess.maxHeartRate;
ADDRLP4 0
INDIRP4
CNSTI4 664
ADDP4
...
ASGNF4
line 1085
;1084:	// set overall reward frequencies
;1085:	if (client->sess.targetHR == HR_TARGET_RECOVERY)
ADDRLP4 0
INDIRP4
CNSTI4 736
ADDP4
...
;1086:	{
line 1087
;1087:		client->pers.rewardFrequencyRecovery = (float) REWARD_MAX_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 680
ADDP4
...
ASGNF4
line 1088
;1088:		client->pers.rewardFrequencyAerobic = (float) REWARD_MED_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 684
ADDP4
...
ASGNF4
line 1089
;1089:		client->pers.powerupFrequencyAnaerobic = (float) REWARD_MIN_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 688
ADDP4
...
LABELV $359
line 1091
;1091:	else if (client->sess.targetHR == HR_TARGET_AEROBIC)
ADDRLP4 0
INDIRP4
CNSTI4 736
ADDP4
...
;1092:	{
line 1093
;1093:		client->pers.rewardFrequencyRecovery = (float) REWARD_MED_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 680
ADDP4
...
ASGNF4
line 1094
;1094:		client->pers.rewardFrequencyAerobic = (float) REWARD_MAX_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 684
ADDP4
...
ASGNF4
line 1095
;1095:		client->pers.powerupFrequencyAnaerobic = (float) REWARD_MIN_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 688
ADDP4
...
;1098:	{
line 1099
;1099:		client->pers.rewardFrequencyRecovery = (float) REWARD_MIN_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 680
ADDP4
...
ASGNF4
line 1100
;1100:		client->pers.rewardFrequencyAerobic = (float) REWARD_MED_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 684
ADDP4
...
ASGNF4
line 1101
;1101:		client->pers.powerupFrequencyAnaerobic = (float) REWARD_MAX_FREQUENCY;
ADDRLP4 0
INDIRP4
CNSTI4 688
ADDP4
...
LABELV $360
line 1104
;1103:	// set and adjust reward drop percentages (considers disabled options of items, weapons, powerups)
;1104:	setRewardPercentages(ent);
ADDRLP4 4
INDIRP4
ARGP4
ADDRGP4 setRewardPercentages
CALLV
pop
line 1106
;1105:	// punishment intervals
;1106:	client->pers.punishmentIntervals[0] = PUNISHMENT_INTERVAL_MAX;
ADDRLP4 0
INDIRP4
CNSTI4 692
ADDP4
...
ASGNI4
line 1107
;1107:	client->pers.punishmentIntervals[1] = PUNISHMENT_INTERVAL_MID;
ADDRLP4 0
INDIRP4
CNSTI4 696
ADDP4
...
ASGNI4
line 1108
;1108:	client->pers.punishmentIntervals[2] = PUNISHMENT_INTERVAL_MIN;
ADDRLP4 0
INDIRP4
CNSTI4 700
ADDP4
...
;1109:	// [ERGO MOD END]
;1110:
;1111:	// save eflags around this, because changing teams will
;1112:	// cause this to happen with a valid entity, and we
;1113:	// want to make sure the teleport bit is set right
;1114:	// so the viewpoint doesn't interpolate through the
;1115:	// world to the new position
;1116:	flags = client->ps.eFlags;
ADDRLP4 8
ADDRLP4 0
INDIRP4
CNSTI4 104
...
ASGNI4
line 1117
;1117:	memset( &client->ps, 0, sizeof( client->ps ) );
ADDRLP4 0
INDIRP4
ARGP4
CNSTI4 0
...
line 1121
;1119:
;1120:	// locate ent at a spawn point
;1121:	ClientSpawn( ent );
ADDRLP4 4
INDIRP4
ARGP4
ADDRGP4 ClientSpawn
...
line 1123
;1122:
;1123:	if ( client->sess.sessionTeam != TEAM_SPECTATOR ) {
ADDRLP4 0
INDIRP4
CNSTI4 704
ADDP4
...
line 1125
;1124:		// send event
;1125:		tent = G_TempEntity( ent->client->ps.origin, EV_PLAYER_TELEPORT_IN );
ADDRLP4 4
INDIRP4
CNSTI4 516
ADDP4
...
ASGNP4
line 1126
;1126:		tent->s.clientNum = ent->s.clientNum;
ADDRLP4 36
CNSTI4 168
ASGNI4
ADDRLP4 12
...
EQI4 $365
line 1129
;1129:			trap_SendServerCommand( -1, va("print \"%s" S_COLOR_WHITE " entered the game\n\"", client->pers.netname) );
ADDRGP4 $368
ARGP4
ADDRLP4 0
INDIRP4
...
LABELV $363
line 1132
;1132:	G_LogPrintf( "ClientBegin: %i\n", clientNum );
ADDRGP4 $369
ARGP4
ADDRFP4 0
INDIRI4
...
line 1135
;1133:
;1134:	// count current clients and rank for scoreboard
;1135:	CalculateRanks();
ADDRGP4 CalculateRanks
CALLV
pop
...
;1140:ClientSpawn
;1141:
;1142:Called every time a client is placed fresh in the world:
;1143:after the first ClientBegin, and after each respawn
;1144:Initializes all non-persistant parts of playerState
;1145:============
;1146:*/
;1147:void ClientSpawn(gentity_t *ent) {
line 1163
;1148:	int		index;
;1149:	vec3_t	spawn_origin, spawn_angles;
;1150:	gclient_t	*client;
;1151:	int		i;
;1152:	clientPersistant_t	saved;
;1153:	clientSession_t		savedSess;
;1154:	int		persistant[MAX_PERSISTANT];
;1155:	gentity_t	*spawnPoint;
;1156:	int		flags;
;1157:	int		savedPing;
;1158://	char	*savedAreaBits;
;1159:	int		accuracy_hits, accuracy_shots;
;1160:	int		eventSequence;
;1161:	char	userinfo[MAX_INFO_STRING];
;1162:
;1163:	index = ent - g_entities;
ADDRLP4 100
ADDRFP4 0
INDIRP4
CVPU4 4
...
;1165:
;1166:	// [ERGO MOD START]
;1167:	// init timer vars (items, powerups,  weapons)	
;1168:	//client->hrRewardTimeResidual = 0;	
;1169:	// [ERGO MOD END]
;1170:
;1171:	// find a spawn point
;1172:	// do it before setting health back up, so farthest
;1173:	// ranging doesn't count this client
;1174:	if ( client->sess.sessionTeam == TEAM_SPECTATOR ) {
ADDRLP4 4
INDIRP4
CNSTI4 704
ADDP4
...
NEI4 $371
line 1175
;1175:		spawnPoint = SelectSpectatorSpawnPoint ( 
ADDRLP4 76
ARGP4
ADDRLP4 88
ARGP4
...
ASGNP4
line 1177
;1176:						spawn_origin, spawn_angles);
;1177:	} else if (g_gametype.integer >= GT_CTF ) {
ADDRGP4 $372
JUMPV
LABELV $371
ADDRGP4 g_gametype+12
...
LTI4 $373
line 1179
;1178:		// all base oriented team games use the CTF spawn points
;1179:		spawnPoint = SelectCTFSpawnPoint ( 
ADDRLP4 4
INDIRP4
CNSTI4 704
ADDP4
...
ASGNP4
line 1183
;1180:						client->sess.sessionTeam, 
;1181:						client->pers.teamState.state, 
;1182:						spawn_origin, spawn_angles);
;1183:	} else {
ADDRGP4 $374
JUMPV
LABELV $373
...
;1184:		do {
line 1186
;1185:			// the first spawn should be at a good looking spot
;1186:			if ( !client->pers.initialSpawn && client->pers.localClient ) {
ADDRLP4 1436
CNSTI4 0
ASGNI4
ADDRLP4 4
...
EQI4 $379
line 1187
;1187:				client->pers.initialSpawn = qtrue;
ADDRLP4 4
INDIRP4
CNSTI4 500
ADDP4
...
ASGNI4
line 1188
;1188:				spawnPoint = SelectInitialSpawnPoint( spawn_origin, spawn_angles );
ADDRLP4 76
ARGP4
ADDRLP4 88
ARGP4
...
LABELV $379
line 1191
;1190:				// don't spawn near existing origin if possible
;1191:				spawnPoint = SelectSpawnPoint ( 
ADDRLP4 4
INDIRP4
CNSTI4 20
ADDP4
...
ASGNP4
line 1194
;1192:					client->ps.origin, 
;1193:					spawn_origin, spawn_angles);
;1194:			}
LABELV $380
line 1198
;1195:
;1196:			// Tim needs to prevent bots from spawning at the initial point
;1197:			// on q3dm0...
;1198:			if ( ( spawnPoint->flags & FL_NO_BOTS ) && ( ent->r.svFlags & SVF_BOT ) ) {
ADDRLP4 1440
CNSTI4 0
ASGNI4
ADDRLP4 72
...
EQI4 $381
line 1199
;1199:				continue;	// try again
ADDRGP4 $377
JUMPV
LABELV $381
line 1202
;1200:			}
;1201:			// just to be symetric, we have a nohumans option...
;1202:			if ( ( spawnPoint->flags & FL_NO_HUMANS ) && !( ent->r.svFlags & SVF_BOT ) ) {
ADDRLP4 1444
CNSTI4 0
ASGNI4
ADDRLP4 72
...
LABELV $372
line 1210
;1210:	client->pers.teamState.state = TEAM_ACTIVE;
ADDRLP4 4
INDIRP4
CNSTI4 556
ADDP4
...
line 1213
;1211:
;1212:	// always clear the kamikaze flag
;1213:	ent->s.eFlags &= ~EF_KAMIKAZE;
ADDRLP4 1432
ADDRFP4 0
INDIRP4
CNSTI4 8
...
line 1217
;1214:
;1215:	// toggle the teleport bit so the client knows to not lerp
;1216:	// and never clear the voted flag
;1217:	flags = ent->client->ps.eFlags & (EF_TELEPORT_BIT | EF_VOTED | EF_TEAMVOTED);
ADDRLP4 104
ADDRFP4 0
INDIRP4
CNSTI4 516
...
line 1222
;1219:
;1220:	// clear everything but the persistant data
;1221:
;1222:	saved = client->pers;
ADDRLP4 1132
ADDRLP4 4
INDIRP4
CNSTI4 468
...
ASGNI4
line 1226
;1225://	savedAreaBits = client->areabits;
;1226:	accuracy_hits = client->accuracy_hits;
ADDRLP4 1420
ADDRLP4 4
INDIRP4
CNSTI4 824
...
ASGNI4
line 1227
;1227:	accuracy_shots = client->accuracy_shots;
ADDRLP4 1424
ADDRLP4 4
INDIRP4
CNSTI4 820
...
LABELV $385
line 1229
;1229:		persistant[i] = client->ps.persistant[i];
ADDRLP4 1436
ADDRLP4 0
INDIRI4
CNSTI4 2
...
LTI4 $385
line 1231
;1231:	eventSequence = client->ps.eventSequence;
ADDRLP4 1428
ADDRLP4 4
INDIRP4
CNSTI4 108
...
line 1233
;1232:
;1233:	memset (client, 0, sizeof(*client)); // bk FIXME: Com_Memset?
ADDRLP4 4
INDIRP4
ARGP4
CNSTI4 0
...
ASGNI4
line 1239
;1238://	client->areabits = savedAreaBits;
;1239:	client->accuracy_hits = accuracy_hits;
ADDRLP4 4
INDIRP4
CNSTI4 824
ADDP4
...
ASGNI4
line 1240
;1240:	client->accuracy_shots = accuracy_shots;
ADDRLP4 4
INDIRP4
CNSTI4 820
ADDP4
...
ASGNI4
line 1241
;1241:	client->lastkilled_client = -1;
ADDRLP4 4
INDIRP4
CNSTI4 828
ADDP4
...
line 1243
;1242:
;1243:	for ( i = 0 ; i < MAX_PERSISTANT ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
LABELV $389
line 1244
;1244:		client->ps.persistant[i] = persistant[i];
ADDRLP4 1436
ADDRLP4 0
INDIRI4
CNSTI4 2
...
LTI4 $389
line 1246
;1246:	client->ps.eventSequence = eventSequence;
ADDRLP4 4
INDIRP4
CNSTI4 108
ADDP4
...
ASGNI4
line 1248
;1247:	// increment the spawncount so the client will detect the respawn
;1248:	client->ps.persistant[PERS_SPAWN_COUNT]++;
ADDRLP4 1436
ADDRLP4 4
INDIRP4
CNSTI4 264
...
ASGNI4
line 1249
;1249:	client->ps.persistant[PERS_TEAM] = client->sess.sessionTeam;
ADDRLP4 4
INDIRP4
CNSTI4 260
ADDP4
...
line 1251
;1250:
;1251:	client->airOutTime = level.time + 12000;
ADDRLP4 4
INDIRP4
CNSTI4 856
ADDP4
...
line 1253
;1252:
;1253:	trap_GetUserinfo( index, userinfo, sizeof(userinfo) );
ADDRLP4 100
INDIRI4
ARGI4
ADDRLP4 108
...
line 1255
;1254:	// set max health
;1255:	client->pers.maxHealth = atoi( Info_ValueForKey( userinfo, "handicap" ) );
ADDRLP4 108
ARGP4
ADDRGP4 $267
ARGP4
...
LABELV $394
line 1260
;1259:	// clear entity values
;1260:	client->ps.stats[STAT_MAX_HEALTH] = client->pers.maxHealth;
ADDRLP4 4
INDIRP4
CNSTI4 208
ADDP4
...
line 1263
;1262:
;1263:	ent->s.groundEntityNum = ENTITYNUM_NONE;
ADDRFP4 0
INDIRP4
CNSTI4 148
ADDP4
...
ASGNI4
line 1264
;1264:	ent->client = &level.clients[index];
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNP4
line 1268
;1268:	ent->r.contents = CONTENTS_BODY;
ADDRFP4 0
INDIRP4
CNSTI4 460
ADDP4
...
ASGNI4
line 1269
;1269:	ent->clipmask = MASK_PLAYERSOLID;
ADDRFP4 0
INDIRP4
CNSTI4 572
ADDP4
...
line 1275
;1274:	
;1275:	VectorCopy (playerMins, ent->r.mins);
ADDRFP4 0
INDIRP4
CNSTI4 436
ADDP4
...
ASGNB 12
line 1276
;1276:	VectorCopy (playerMaxs, ent->r.maxs);
ADDRFP4 0
INDIRP4
CNSTI4 448
ADDP4
...
line 1278
;1277:
;1278:	client->ps.clientNum = index;
ADDRLP4 4
INDIRP4
CNSTI4 140
ADDP4
...
line 1280
;1279:
;1280:	client->ps.stats[STAT_WEAPONS] = ( 1 << WP_MACHINEGUN );
ADDRLP4 4
INDIRP4
CNSTI4 192
ADDP4
...
NEI4 $398
line 1282
;1282:		client->ps.ammo[WP_MACHINEGUN] = 50;
ADDRLP4 4
INDIRP4
CNSTI4 384
ADDP4
...
LABELV $398
line 1284
;1284:		client->ps.ammo[WP_MACHINEGUN] = 100;
ADDRLP4 4
INDIRP4
CNSTI4 384
ADDP4
...
line 1287
;1286:
;1287:	client->ps.stats[STAT_WEAPONS] |= ( 1 << WP_GAUNTLET );
ADDRLP4 1460
ADDRLP4 4
INDIRP4
CNSTI4 192
...
ASGNI4
line 1288
;1288:	client->ps.ammo[WP_GAUNTLET] = -1;
ADDRLP4 4
INDIRP4
CNSTI4 380
ADDP4
...
ASGNI4
line 1289
;1289:	client->ps.ammo[WP_GRAPPLING_HOOK] = -1;
ADDRLP4 4
INDIRP4
CNSTI4 416
ADDP4
...
line 1292
;1290:
;1291:	// health will count down towards max_health
;1292:	ent->health = client->ps.stats[STAT_HEALTH] = client->ps.stats[STAT_MAX_HEALTH] + 25;
ADDRLP4 1468
ADDRLP4 4
INDIRP4
CNSTI4 208
...
line 1294
;1293:
;1294:	G_SetOrigin( ent, spawn_origin );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 76
...
pop
line 1295
;1295:	VectorCopy( spawn_origin, client->ps.origin );
ADDRLP4 4
INDIRP4
CNSTI4 20
ADDP4
...
line 1298
;1296:
;1297:	// the respawned flag will be cleared after the attack and jump keys come up
;1298:	client->ps.pm_flags |= PMF_RESPAWNED;
ADDRLP4 1472
ADDRLP4 4
INDIRP4
CNSTI4 12
...
line 1300
;1299:
;1300:	trap_GetUsercmd( client - level.clients, &ent->client->pers.cmd );
ADDRLP4 4
INDIRP4
CVPU4 4
ADDRGP4 level
...
pop
line 1301
;1301:	SetClientViewAngle( ent, spawn_angles );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 88
...
line 1303
;1302:
;1303:	if ( ent->client->sess.sessionTeam == TEAM_SPECTATOR ) {
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
line 1310
;1308:
;1309:		// force the base weapon up
;1310:		client->ps.weapon = WP_MACHINEGUN;
ADDRLP4 4
INDIRP4
CNSTI4 144
ADDP4
...
ASGNI4
line 1311
;1311:		client->ps.weaponstate = WEAPON_READY;
ADDRLP4 4
INDIRP4
CNSTI4 148
ADDP4
...
line 1316
;1314:
;1315:	// don't allow full run speed for a bit
;1316:	client->ps.pm_flags |= PMF_TIME_KNOCKBACK;
ADDRLP4 1476
ADDRLP4 4
INDIRP4
CNSTI4 12
...
line 1319
;1318:
;1319:	client->respawnTime = level.time;
ADDRLP4 4
INDIRP4
CNSTI4 840
ADDP4
...
ASGNI4
line 1320
;1320:	client->inactivityTime = level.time + g_inactivity.integer * 1000;
ADDRLP4 4
INDIRP4
CNSTI4 844
ADDP4
...
line 1324
;1322:
;1323:	// set default animations
;1324:	client->ps.torsoAnim = TORSO_STAND;
ADDRLP4 4
INDIRP4
CNSTI4 84
ADDP4
...
ASGNI4
line 1325
;1325:	client->ps.legsAnim = LEGS_IDLE;
ADDRLP4 4
INDIRP4
CNSTI4 76
ADDP4
...
line 1327
;1326:
;1327:	if ( level.intermissiontime ) {
ADDRGP4 level+9128
INDIRI4
CNSTI4 0
EQI4 $406
line 1328
;1328:		MoveClientToIntermission( ent );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $406
line 1331
;1330:		// fire the targets of the spawn point
;1331:		G_UseTargets( spawnPoint, ent );
ADDRLP4 72
INDIRP4
ARGP4
ADDRFP4 0
...
line 1335
;1332:
;1333:		// select the highest weapon number available, after any
;1334:		// spawn given items have fired
;1335:		client->ps.weapon = 1;
ADDRLP4 4
INDIRP4
CNSTI4 144
ADDP4
...
ASGNI4
line 1336
;1336:		for ( i = WP_NUM_WEAPONS - 1 ; i > 0 ; i-- ) {
ADDRLP4 0
CNSTI4 10
ASGNI4
LABELV $409
line 1337
;1337:			if ( client->ps.stats[STAT_WEAPONS] & ( 1 << i ) ) {
ADDRLP4 4
INDIRP4
CNSTI4 192
ADDP4
...
line 1346
;1343:
;1344:	// run a client frame to drop exactly to the floor,
;1345:	// initialize animations and other things
;1346:	client->ps.commandTime = level.time - 100;
ADDRLP4 4
INDIRP4
ADDRGP4 level+32
INDIRI4
...
ASGNI4
line 1347
;1347:	ent->client->pers.cmd.serverTime = level.time;
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNI4
line 1348
;1348:	ClientThink( ent-g_entities );
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
...
line 1351
;1349:
;1350:	// positively link the client, even if the command times are weird
...
EQI4 $417
line 1352
;1352:		BG_PlayerStateToEntityState( &client->ps, &ent->s, qtrue );
ADDRLP4 4
INDIRP4
ARGP4
ADDRFP4 0
...
pop
line 1353
;1353:		VectorCopy( ent->client->ps.origin, ent->r.currentOrigin );
ADDRLP4 1480
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1358
;1356:
;1357:	// run the presend to set anything else
;1358:	ClientEndFrame( ent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 1361
;1359:
;1360:	// clear entity state values
;1361:	BG_PlayerStateToEntityState( &client->ps, &ent->s, qtrue );
ADDRLP4 4
INDIRP4
ARGP4
ADDRFP4 0
...
;1365:/*
;1366:===========
;1367:ClientDisconnect
;1368:
;1369:Called when a player drops from the server.
;1370:Will not be called between levels.
;1371:
;1372:This should NOT be called directly by any game logic,
;1373:call trap_DropClient(), which will call this and do
;1374:server system housekeeping.
;1375:============
;1376:*/
;1377:void ClientDisconnect( int clientNum ) {
line 1384
;1378:	gentity_t	*ent;
;1379:	gentity_t	*tent;
;1380:	int			i;
;1381:
;1382:	// cleanup if we are kicking a bot that
;1383:	// hasn't spawned yet
;1384:	G_RemoveQueuedBotBegin( clientNum );
ADDRFP4 0
INDIRI4
ARGI4
...
;1389:	}
;1390:
;1391:	// stop any following clients
;1392:	for ( i = 0 ; i < level.maxclients ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $425
...
LABELV $422
line 1393
;1393:		if ( level.clients[i].sess.sessionTeam == TEAM_SPECTATOR
ADDRLP4 12
CNSTI4 916
ADDRLP4 0
INDIRI4
...
NEI4 $427
line 1395
;1394:			&& level.clients[i].sess.spectatorState == SPECTATOR_FOLLOW
;1395:			&& level.clients[i].sess.spectatorClient == clientNum ) {
line 1396
;1396:			StopFollowing( &g_entities[i] );
CNSTI4 808
ADDRLP4 0
INDIRI4
MULI4
...
line 1401
;1399:
;1400:	// send effect if they were completely connected
;1401:	if ( ent->client->pers.connected == CON_CONNECTED 
ADDRLP4 12
ADDRLP4 4
INDIRP4
CNSTI4 516
...
EQI4 $429
line 1402
;1402:		&& ent->client->sess.sessionTeam != TEAM_SPECTATOR ) {
line 1403
;1403:		tent = G_TempEntity( ent->client->ps.origin, EV_PLAYER_TELEPORT_OUT );
ADDRLP4 4
INDIRP4
CNSTI4 516
ADDP4
...
ASGNP4
line 1404
;1404:		tent->s.clientNum = ent->s.clientNum;
ADDRLP4 20
CNSTI4 168
ASGNI4
ADDRLP4 8
...
line 1408
;1405:
;1406:		// They don't get to take powerups with them!
;1407:		// Especially important for stuff like CTF flags
;1408:		TossClientItems( ent );
ADDRLP4 4
INDIRP4
ARGP4
...
pop
line 1416
;1409:#ifdef MISSIONPACK
;1410:		TossClientPersistantPowerups( ent );
;1411:		if( g_gametype.integer == GT_HARVESTER ) {
;1412:			TossClientCubes( ent );
;1413:		}
;1414:#endif
;1415:
;1416:	}
...
line 1418
;1417:
;1418:	G_LogPrintf( "ClientDisconnect: %i\n", clientNum );
ADDRGP4 $431
ARGP4
ADDRFP4 0
INDIRI4
...
line 1421
;1419:
;1420:	// if we are playing in tourney mode and losing, give a win to the other player
...
NEI4 $432
line 1423
;1422:		&& !level.intermissiontime
;1423:		&& !level.warmupTime && level.sortedClients[1] == clientNum ) {
line 1424
;1424:		level.clients[ level.sortedClients[0] ].sess.wins++;
ADDRLP4 20
CNSTI4 916
ADDRGP4 level+84
INDIRI4
...
ASGNI4
line 1425
;1425:		ClientUserinfoChanged( level.sortedClients[0] );
ADDRGP4 level+84
INDIRI4
ARGI4
ADDRGP4 ClientUserinfoChanged
...
ASGNI4
line 1431
;1431:	ent->classname = "disconnected";
ADDRLP4 4
INDIRP4
CNSTI4 524
ADDP4
...
ASGNP4
line 1432
;1432:	ent->client->pers.connected = CON_DISCONNECTED;
ADDRLP4 4
INDIRP4
CNSTI4 516
ADDP4
...
ASGNI4
line 1433
;1433:	ent->client->ps.persistant[PERS_TEAM] = TEAM_FREE;
ADDRLP4 4
INDIRP4
CNSTI4 516
ADDP4
...
ASGNI4
line 1434
;1434:	ent->client->sess.sessionTeam = TEAM_FREE;
ADDRLP4 4
INDIRP4
CNSTI4 516
ADDP4
...
line 1436
;1435:
;1436:	trap_SetConfigstring( CS_PLAYERS + clientNum, "");
ADDRFP4 0
INDIRI4
CNSTI4 544
ADDI4
...
EQI4 $443
line 1441
;1441:		BotAIShutdownClient( clientNum, qfalse );
ADDRFP4 0
INDIRI4
ARGI4
CNSTI4 0
