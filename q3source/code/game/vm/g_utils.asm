...
export getRatePerMinute
proc getRatePerMinute 8 0
ADDRFP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
;667:
;668:// [ERGO MOD START]
;669:float getRatePerMinute(const int actualTime, const int lastEvent)
;670:{	
line 672
;671:	float rate; // events per minute 
;672:	rate = 0.0f;
ADDRLP4 0
CNSTF4 0
ASGNF4
...
;674:	{
line 676
;675:		// TODO fix problem: level.time only gets adjusted every 50 ms
;676:		int elapsed = (level.time - lastEvent); // msec
ADDRLP4 4
ADDRGP4 level+32
INDIRI4
ADDRFP4 4
...
line 679
;677:		
;678:		//if (elapsed < 1) elapsed = 1; // no need to check for elapsed ns
;679:		if (elapsed > 0)
ADDRLP4 4
INDIRI4
CNSTI4 0
...
;680:		{
line 681
;681:			rate = (60.0f * 1000.0f) / (float) elapsed;
ADDRLP4 0
CNSTF4 1198153728
ADDRLP4 4
INDIRI4
...
;691:
;692:// [ERGO MOD START]
;693:void debugPrint(gentity_t *ent, char *text, ...)
;694:{
line 697
;695:	va_list args;
;696:
;697:	if (!ent->client->sess.modDebug) return;
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNP4
line 700
;700:	trap_SendServerCommand(ent - g_entities, va(text, args));
ADDRFP4 4
INDIRP4
ARGP4
ADDRLP4 0
