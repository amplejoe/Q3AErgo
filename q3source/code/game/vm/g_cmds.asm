...
export Cmd_BikeCycle_f
proc Cmd_BikeCycle_f 12 0
line 1571
;1568:
;1569:// [ERGO MOD START]
...
ASGNP4
line 1578
;1577:	//ucmd = &client->pers.cmd;
;1578:	client->buttons |= BUTTON_BIKE_CYCLE; // record this cycle
ADDRLP4 8
ADDRLP4 0
INDIRP4
CNSTI4 764
...
line 1584
;1579:	
;1580:	// cycles per minute (rpm) - now calculated in g_active (every frame)
;1581:	//int rate = getRatePerMinute(ent->client->pers.lastBikeCycleTime);
;1582:	//trap_SendServerCommand(ent - g_entities, va("print \"Bike Cycle completed: %.3f rpm\n\"", client->pers.brSamples));
;1583:	
;1584:}
LABELV $835
endproc Cmd_BikeCycle_f 12 0
export Cmd_HeartBeat_f
proc Cmd_HeartBeat_f 8 0
line 1589
;1585:// [ERGO MOD END]
;1586:
;1587:// [ERGO MOD START]
...
;1589:{
line 1594
;1590:	gclient_t	*client;
;1591:
;1592:	//float		rate;
;1593:
;1594:	client = ent->client;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
line 1596
;1595:
;1596:	client->buttons |= BUTTON_HEART_BEAT; // record this beat
ADDRLP4 4
ADDRLP4 0
INDIRP4
CNSTI4 764
...
ASGNI4
line 1606
;1597:	// beats per minute (bpm) - now calculated in g_active (every frame)
;1598:	//int rate = getRatePerMinute(client->pers.lastHeartBeatTime);
;1599:	//int maxRate = trap_Cvar_VariableValue("age");
;1600:	/*trap_SendServerCommand(ent - g_entities, va("print \"Heart Beat detected: %.3f bpm (max: %d), [Recovery|Aerobic|Anaerobic]: |%.3f-%.3f|%.3f-%.3f|%.3f-%.3f|\n\"", 
;1601:		client->pers.hrSamples, client->sess.maxHeartRate, 
;1602:		client->pers.minRecoveryHR, client->pers.minAerobicHR-0.001, 
;1603:		client->pers.minAerobicHR, client->pers.minAnaerobicHR-0.001,
;1604:		client->pers.minAnaerobicHR, client->pers.maxAnaerobicHR-0.001));*/
;1605:	
;1606:}
LABELV $836
endproc Cmd_HeartBeat_f 8 0
export Cmd_ErgoStatus_f
proc Cmd_ErgoStatus_f 296 12
line 1611
;1607:// [ERGO MOD END]
;1608:
;1609:// [ERGO MOD START]
;1610:void Cmd_ErgoStatus_f(gentity_t *ent)
;1611:{
line 1614
;1612:	char buf[256];
;1613:			
;1614:	trap_Cvar_VariableStringBuffer("hrtarget", buf, sizeof(buf));
ADDRGP4 $838
ARGP4
ADDRLP4 0
ARGP4
...
pop
line 1615
;1615:	if (ent->client->sess.ergoFlags & E_FL_HRMODE) trap_SendServerCommand(ent - g_entities, va("print \"HR MODE: ON (TARGET HR: %s)\n\"", buf));
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $839
line 1616
;1616:	else trap_SendServerCommand(ent - g_entities, va("print \"HR MODE: OFF\n\""));
ADDRGP4 $842
ARGP4
ADDRLP4 260
ADDRGP4 va
...
LABELV $840
line 1617
;1617:	if (ent->client->sess.ergoFlags & E_FL_ITEMS) trap_SendServerCommand(ent - g_entities, va("print \"ITEMS: ON (rate: %.3f)\n\"", ent->client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_ITEMS]));
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $843
line 1618
;1618:	else trap_SendServerCommand(ent - g_entities, va("print \"ITEMS: OFF\n\""));
ADDRGP4 $846
ARGP4
ADDRLP4 268
ADDRGP4 va
...
LABELV $844
line 1619
;1619:	if (ent->client->sess.ergoFlags & E_FL_WEAPONS) trap_SendServerCommand(ent - g_entities, va("print \"WEAPONS: ON (rate: %.3f)\n\"", ent->client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_WEAPONS]));
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $847
line 1620
;1620:	else trap_SendServerCommand(ent - g_entities, va("print \"WEAPONS: OFF\n\""));
ADDRGP4 $850
ARGP4
ADDRLP4 276
ADDRGP4 va
...
LABELV $848
line 1621
;1621:	if (ent->client->sess.ergoFlags & E_FL_POWERUPS) trap_SendServerCommand(ent - g_entities, va("print \"POWERUPS: ON (rate: %.3f)\n\"", ent->client->pers.rewardDropPercentages[REWARD_DROPRATE_INDEX_POWERUPS]));
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $851
line 1622
;1622:	else trap_SendServerCommand(ent - g_entities, va("print \"POWERUPS: OFF\n\""));
ADDRGP4 $854
ARGP4
ADDRLP4 284
ADDRGP4 va
...
LABELV $852
line 1623
;1623:	if (ent->client->sess.ergoFlags & E_FL_WORLDDROPS) trap_SendServerCommand(ent - g_entities, va("print \"WORLD DROPS: ON \n\""));
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $855
line 1624
;1624:	else trap_SendServerCommand(ent - g_entities, va("print \"WORLD DROPS: OFF\n\""));
ADDRGP4 $858
ARGP4
ADDRLP4 292
ADDRGP4 va
...
;1625:}
LABELV $837
endproc Cmd_ErgoStatus_f 296 12
export resetHeartRateZones
proc resetHeartRateZones 44 36
line 1630
;1626:// [ERGO MOD END]
;1627:
;1628:// [ERGO MOD START]
;1629:void resetHeartRateZones(gentity_t *ent)
;1630:{
line 1633
;1631:	char	*originalString;
;1632:	int		originalMaxHr;
;1633:	originalString = "";
ADDRLP4 0
ADDRGP4 $860
ASGNP4
line 1635
;1634:
;1635:	originalMaxHr = 206.9 - (0.67 * ent->client->sess.age);
ADDRLP4 4
CNSTF4 1129244262
CNSTF4 1059816735
ADDRFP4 0
...
ASGNI4
line 1636
;1636:	if (originalMaxHr == ent->client->sess.maxHeartRate) originalString = "ORIGINAL";
ADDRLP4 4
INDIRI4
ADDRFP4 0
INDIRP4
...
line 1639
;1637:
;1638:	// reset heart rate zones
;1639:	ent->client->pers.minRecoveryHR = HR_RECOVERY_LOWER_BOUND * (float)ent->client->sess.maxHeartRate;
ADDRLP4 8
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNF4
line 1640
;1640:	ent->client->pers.minAerobicHR = HR_AEROBIC_LOWER_BOUND * (float)ent->client->sess.maxHeartRate;
ADDRLP4 12
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNF4
line 1641
;1641:	ent->client->pers.minAnaerobicHR = HR_ANAEROBIC_LOWER_BOUND * (float)ent->client->sess.maxHeartRate;
ADDRLP4 16
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNF4
line 1642
;1642:	ent->client->pers.maxAnaerobicHR = HR_ANAEROBIC_UPPER_BOUND * (float)ent->client->sess.maxHeartRate;
ADDRLP4 20
ADDRFP4 0
INDIRP4
CNSTI4 516
...
line 1644
;1643:
;1644:	trap_SendServerCommand(ent - g_entities, va("print \"%s MAX HR = %d, recovery[%.1f-%.1f], aerobic[%.1f-%.1f], anaerobic[%.1f-%.1f]\n\"",
ADDRGP4 $864
ARGP4
ADDRLP4 0
INDIRP4
...
pop
line 1650
;1645:		originalString, ent->client->sess.maxHeartRate,
;1646:		ent->client->pers.minRecoveryHR, ent->client->pers.minAerobicHR - 0.001,
;1647:		ent->client->pers.minAerobicHR, ent->client->pers.minAnaerobicHR - 0.001,
;1648:		ent->client->pers.minAnaerobicHR, ent->client->pers.maxAnaerobicHR - 0.001));
;1649:	
;1650:}
LABELV $859
endproc resetHeartRateZones 44 36
export Cmd_IncHR_f
proc Cmd_IncHR_f 4 4
line 1655
;1651:// [ERGO MOD END]
;1652:
;1653:// [ERGO MOD START]
;1654:void Cmd_IncHR_f(gentity_t *ent)
;1655:{	
line 1656
;1656:	ent->client->sess.maxHeartRate += HR_INC_DEC;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNI4
line 1657
;1657:	if (ent->client->sess.maxHeartRate >= HR_BOUND_UPPER) ent->client->sess.maxHeartRate = HR_BOUND_UPPER;
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
LABELV $866
line 1658
;1658:	resetHeartRateZones(ent);
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 resetHeartRateZones
CALLV
pop
line 1659
;1659:}
LABELV $865
endproc Cmd_IncHR_f 4 4
export Cmd_DecHR_f
proc Cmd_DecHR_f 4 4
line 1664
;1660:// [ERGO MOD END]
;1661:
;1662:// [ERGO MOD START]
;1663:void Cmd_DecHR_f(gentity_t *ent)
;1664:{
line 1665
;1665:	ent->client->sess.maxHeartRate -= HR_INC_DEC;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNI4
line 1666
;1666:	if (ent->client->sess.maxHeartRate <= HR_BOUND_LOWER) ent->client->sess.maxHeartRate = HR_BOUND_LOWER;		
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
;1668:}
LABELV $868
endproc Cmd_DecHR_f 4 4
export Cmd_IncNumHRSamples_f
proc Cmd_IncNumHRSamples_f 8 8
line 1673
;1669:// [ERGO MOD END]
;1670:
;1671:// [ERGO MOD START]
;1672:void Cmd_IncNumHRSamples_f(gentity_t *ent)
;1673:{
line 1674
;1674:	ent->client->pers.hrNumSamples += 1;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNI4
line 1675
;1675:	if (ent->client->pers.hrNumSamples >= 60) ent->client->pers.hrNumSamples = 60;
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
line 1677
;1676:
;1677:	trap_SendServerCommand(ent - g_entities, va("print \"Num HR Samples: %d\n\"", ent->client->pers.hrNumSamples));
ADDRGP4 $874
ARGP4
ADDRFP4 0
INDIRP4
...
;1678:}
LABELV $871
endproc Cmd_IncNumHRSamples_f 8 8
export Cmd_DecNumHRSamples_f
proc Cmd_DecNumHRSamples_f 8 8
line 1683
;1679:// [ERGO MOD END]
;1680:
;1681:// [ERGO MOD START]
;1682:void Cmd_DecNumHRSamples_f(gentity_t *ent)
;1683:{
line 1684
;1684:	ent->client->pers.hrNumSamples -= 1;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNI4
line 1685
;1685:	if (ent->client->pers.hrNumSamples <= 1) ent->client->pers.hrNumSamples = 1;
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
line 1687
;1686:
;1687:	trap_SendServerCommand(ent - g_entities, va("print \"Num HR Samples: %d\n\"", ent->client->pers.hrNumSamples));
ADDRGP4 $874
ARGP4
ADDRFP4 0
INDIRP4
...
;1688:}
LABELV $875
endproc Cmd_DecNumHRSamples_f 8 8
export Cmd_DebugMod_f
proc Cmd_DebugMod_f 16 8
line 1693
;1689:// [ERGO MOD END]
;1690:
;1691:// [ERGO MOD START]
;1692:void Cmd_DebugMod_f(gentity_t *ent)
;1693:{
line 1694
;1694:	ent->client->sess.modDebug = !ent->client->sess.modDebug;
ADDRLP4 4
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNI4
line 1695
;1695:	trap_SendServerCommand(ent - g_entities, va("print \"Debugging %s\n\"", (ent->client->sess.modDebug) ? "ON" : "OFF"));
ADDRGP4 $882
ARGP4
ADDRFP4 0
INDIRP4
...
;1702:=================
;1703:*/
;1704:void Cmd_Stats_f( gentity_t *ent ) {
line 1719
;1705:/*
;1706:	int max, n, i;
;1707:
;1708:	max = trap_AAS_PointReachabilityAreaIndex( NULL );
;1709:
;1710:	n = 0;
;1711:	for ( i = 0; i < max; i++ ) {
;1712:		if ( ent->client->areabits[i >> 3] & (1 << (i & 7)) )
;1713:			n++;
;1714:	}
;1715:
;1716:	//trap_SendServerCommand( ent-g_entities, va("print \"visited %d of %d areas\n\"", n, max));
;1717:	trap_SendServerCommand( ent-g_entities, va("print \"%d%% level coverage\n\"", n * 100 / max));
;1718:*/
;1719:}
LABELV $888
...
NEU4 $890
line 1732
;1732:		return;		// not fully in game yet
ADDRGP4 $889
JUMPV
LABELV $890
line 1736
...
;1734:
;1735:
;1736:	trap_Argv( 0, cmd, sizeof( cmd ) );
CNSTI4 0
ARGI4
ADDRLP4 0
ARGP4
...
NEI4 $892
line 1739
;1739:		Cmd_Say_f (ent, SAY_ALL, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1032
...
line 1742
;1741:	}
;1742:	if (Q_stricmp (cmd, "say_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $897
ARGP4
...
NEI4 $895
line 1743
;1743:		Cmd_Say_f (ent, SAY_TEAM, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
NEI4 $901
line 1751
;1751:		Cmd_Voice_f (ent, SAY_ALL, qfalse, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1044
...
line 1754
;1753:	}
;1754:	if (Q_stricmp (cmd, "vsay_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $906
ARGP4
...
NEI4 $904
line 1755
;1755:		Cmd_Voice_f (ent, SAY_TEAM, qfalse, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
NEI4 $907
line 1759
;1759:		Cmd_VoiceTell_f ( ent, qfalse );
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 0
...
NEI4 $909
line 1763
;1763:		Cmd_Voice_f (ent, SAY_ALL, qfalse, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1056
...
line 1766
;1765:	}
;1766:	if (Q_stricmp (cmd, "vosay_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $914
ARGP4
...
NEI4 $912
line 1767
;1767:		Cmd_Voice_f (ent, SAY_TEAM, qfalse, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1060
...
line 1770
;1769:	}
;1770:	if (Q_stricmp (cmd, "votell") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $917
ARGP4
...
NEI4 $915
line 1771
;1771:		Cmd_VoiceTell_f ( ent, qtrue );
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
line 1774
;1773:	}
;1774:	if (Q_stricmp (cmd, "vtaunt") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $920
ARGP4
...
;1781:	}
;1782:	// [ERGO MOD START] 
;1783:	// Note: do not use "heartbeat" - game will ignore this (command already exists but does nothing)
;1784:	if (Q_stricmp(cmd, "heart") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $925
ARGP4
...
NEI4 $923
line 1785
;1785:		Cmd_HeartBeat_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_HeartBeat_f
CALLV
pop
line 1786
;1786:		return;
...
line 1788
;1787:	}
;1788:	if (Q_stricmp(cmd, "bikecycle") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $928
ARGP4
...
;1789:	{
line 1790
;1790:		Cmd_BikeCycle_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_BikeCycle_f
CALLV
pop
line 1791
;1791:		return;
...
line 1793
;1792:	}		
;1793:	if (Q_stricmp(cmd, "ergostatus") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $931
ARGP4
...
;1794:	{
line 1795
;1795:		Cmd_ErgoStatus_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_ErgoStatus_f
CALLV
pop
line 1796
;1796:		return;
...
line 1808
;1807:	}
;1808:	if (Q_stricmp(cmd, "incnumhrsamples") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $940
ARGP4
...
;1809:	{
line 1810
;1810:		Cmd_IncNumHRSamples_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_IncNumHRSamples_f
CALLV
pop
line 1811
;1811:		return;
...
line 1813
;1812:	}
;1813:	if (Q_stricmp(cmd, "decnumhrsamples") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $943
ARGP4
...
;1814:	{
line 1815
;1815:		Cmd_DecNumHRSamples_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_DecNumHRSamples_f
CALLV
pop
line 1816
;1816:		return;
...
line 1818
;1817:	}
;1818:	if (Q_stricmp(cmd, "debugmod") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $946
ARGP4
...
;1819:	{
line 1820
;1820:		Cmd_DebugMod_f(ent);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRGP4 Cmd_DebugMod_f
CALLV
pop
line 1821
;1821:		return;
...
;1823:	// [ERGO MOD END]
;1824:
;1825:	// ignore all other commands when at intermission
;1826:	if (level.intermissiontime) {
ADDRGP4 level+9128
INDIRI4
CNSTI4 0
EQI4 $947
line 1827
;1827:		Cmd_Say_f (ent, qfalse, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 0
...
LABELV $950
line 1833
;1833:	else if (Q_stricmp (cmd, "god") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $955
ARGP4
...
LABELV $953
line 1835
;1835:	else if (Q_stricmp (cmd, "notarget") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $958
ARGP4
...
LABELV $956
line 1837
;1837:	else if (Q_stricmp (cmd, "noclip") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $961
ARGP4
...
LABELV $959
line 1839
;1839:	else if (Q_stricmp (cmd, "kill") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $964
ARGP4
...
LABELV $962
line 1841
;1841:	else if (Q_stricmp (cmd, "teamtask") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $220
ARGP4
...
LABELV $965
line 1843
;1843:	else if (Q_stricmp (cmd, "levelshot") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $969
ARGP4
...
LABELV $967
line 1845
;1845:	else if (Q_stricmp (cmd, "follow") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $972
ARGP4
...
LABELV $970
line 1847
;1847:	else if (Q_stricmp (cmd, "follownext") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $975
ARGP4
...
LABELV $973
line 1849
;1849:	else if (Q_stricmp (cmd, "followprev") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $978
ARGP4
...
LABELV $976
line 1851
;1851:	else if (Q_stricmp (cmd, "team") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $981
ARGP4
...
LABELV $979
line 1853
;1853:	else if (Q_stricmp (cmd, "where") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $984
ARGP4
...
LABELV $982
line 1855
;1855:	else if (Q_stricmp (cmd, "callvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $987
ARGP4
...
LABELV $985
line 1857
;1857:	else if (Q_stricmp (cmd, "vote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $990
ARGP4
...
LABELV $988
line 1859
;1859:	else if (Q_stricmp (cmd, "callteamvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $993
ARGP4
...
LABELV $991
line 1861
;1861:	else if (Q_stricmp (cmd, "teamvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $996
ARGP4
...
LABELV $994
line 1863
;1863:	else if (Q_stricmp (cmd, "gc") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $999
ARGP4
...
LABELV $997
line 1865
;1865:	else if (Q_stricmp (cmd, "setviewpos") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1002
ARGP4
...
LABELV $1000
line 1867
;1867:	else if (Q_stricmp (cmd, "stats") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1005
ARGP4
...
line 1870
;1869:	else
;1870:		trap_SendServerCommand( clientNum, va("print \"unknown cmd %s\n\"", cmd ) );
ADDRGP4 $1006
ARGP4
ADDRLP4 0
ARGP4
