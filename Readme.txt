...
Installation:
	- The custom batch files for compiling and running need to find the purchased Quake 3 Arena game: either copy/move 
	  the contents of your Quake 3 Arena installation directory to the 'Quake3' folder in this directory or change the
	  filepath variable 
	   in create_qvm.bat and runmod.bat to point to your Quake 3 Arena installation path.
	-  If you chose the latter you have to manually copy the 'Quake3\testmod' directory to your installation directory, 
	   as the mod
	   is installed to this directory and the .cfg files are needed to run it.
	-  If your resulution is different than HD (1920x1080) change width & height in 'runmod.bat' to match your 
	   resolution

Modding:
	- Open q3source\code\quake3.sln in Visual Studio; version 2013 was used for creating the mod, but it can easily be
	  converted.
